...
- `src/content/minimal/` contains the Task 4.1 provisional archetype and rival configuration, content-specific validation, the initializer for one core-validated resolver-ready `GameState`, and the content-owned fixed ten-action Task 9.2 scripted-session helper. Content imports core contracts, validators, and public orchestration APIs; `game-core` does not import content.
